# Train XGBoost on features_rul.csv, grouped 5-fold CV by battery (no leakage)
...
def main():
    ...
    print_results("XGBoost", results)

    results["model"] = "XGBoost"
    out_path = Path(args.features_csv).parent / "xgb_rul_results.csv"
